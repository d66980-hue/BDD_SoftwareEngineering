...
public class ProductController {
	...
	public ResponseEntity<Product> getProduct() {
		...
		//return ResponseEntity.ok(new Product("Testing")); //runs but gives error in test because of mismatch in expected and actual value
	}
	 ...
	 * @throws Exception
	 */
	@GetMapping("/product/createFile/{fileName}")
